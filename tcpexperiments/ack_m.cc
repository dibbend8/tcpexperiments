...
void Ack::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->price1);
    doParsimPacking(b,this->price2);
...
void Ack::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->price1);
    doParsimUnpacking(b,this->price2);
    doParsimUnpacking(b,this->id);
}

double Ack::getPrice1() const
{
    return this->price1;
}

void Ack::setPrice1(double price1)
{
    this->price1 = price1;
}

double Ack::getPrice2() const
{
    return this->price2;
}

void Ack::setPrice2(double price2)
{
    this->price2 = price2;
}
...
unsigned int AckDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_price1
        FD_ISEDITABLE,    // FIELD_price2
...
int AckDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "price1") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "price2") == 0) return baseIndex + 1;
...
std::string AckDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Ack *pp = omnetpp::fromAnyPtr<Ack>(object); (void)pp;
    switch (field) {
        case FIELD_price1: return double2string(pp->getPrice1());
        case FIELD_price2: return double2string(pp->getPrice2());
...
void AckDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    Ack *pp = omnetpp::fromAnyPtr<Ack>(object); (void)pp;
    switch (field) {
        case FIELD_price1: pp->setPrice1(string2double(value)); break;
        case FIELD_price2: pp->setPrice2(string2double(value)); break;
...
omnetpp::cValue AckDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Ack *pp = omnetpp::fromAnyPtr<Ack>(object); (void)pp;
    switch (field) {
        case FIELD_price1: return pp->getPrice1();
        case FIELD_price2: return pp->getPrice2();
...
void AckDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    Ack *pp = omnetpp::fromAnyPtr<Ack>(object); (void)pp;
    switch (field) {
        case FIELD_price1: pp->setPrice1(value.doubleValue()); break;
        case FIELD_price2: pp->setPrice2(value.doubleValue()); break;
